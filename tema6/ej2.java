...
public class ej2 {
    ...
    int carta= (int)(Math.random()*5);
    switch(carta){
      case 1: System.out.print("de picas");
      break;
      case 2: System.out.print("de treboles");
      break;
      case 3: System.out.print("de corazones");
      break;
      case 4: System.out.print("de diamantes");
      break;
    }
	}
}
